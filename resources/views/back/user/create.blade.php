                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="@error('name')'errorInput'@enderror" class="form-control" name="name">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" id="@error('email') ? 'errorInput' @enderror" class="form-control" name="email">
                        </div>
                        @error('email')
                        <span class="text-danger">{{$message}}</span>
                        @enderror    
