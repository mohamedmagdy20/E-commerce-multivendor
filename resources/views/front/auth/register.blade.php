      ...
      <div class="d-lg-flex">
        ...
        <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
          ...
          <div class="nav fs-sm mb-3 mb-lg-4">
            ...
            <a class="nav-link text-decoration-underline p-0 ms-2" href="{{route('login.view')}}">Sign in</a>
          </div>

          <!-- Form -->
          <form class="needs-validation" method="POST" action="{{route('registerPost')}}" novalidate="" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-4">
                  ...
                  <div class="password-toggle">
                    <input type="password" class="form-control form-control-lg" id="register-password" name="password_confirmation" minlength="8" placeholder="Minimum 8 characters" required="">
                    <div class="invalid-tooltip bg-transparent py-0">Password does not meet the required criteria!</div>
                    <label class="password-toggle-button fs-lg" aria-label="Show/hide password">
                      <input type="checkbox" class="btn-check">
                    </label>
