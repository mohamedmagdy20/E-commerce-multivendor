...
<section class="container pt-2 pt-lg-3">
	  ...
	  <div class="row align-items-center position-relative z-2">
		<div class="col-md-5 col-lg-4 offset-lg-1 text-center text-md-start mb-4 mb-md-0">
		  <div class="pt-5 pt-md-0 px-4 px-sm-5 pe-md-0 ps-md-5 ps-lg-0">
			<p class="fs-xl mb-lg-4">The new stylish collection</p>
			<h1 class="display-4 text-uppercase mb-4 mb-lg-5">New fall <span class="text-nowrap">season 2024</span></h1>
			<a class="btn btn-lg btn-dark" href="shop-catalog-fashion.html">
			  Shop now
		...
		<div class="col-md-7 mt-md-n5">
		  <div class="d-flex justify-content-center justify-content-md-end">
			<div class="position-relative w-100 rtl-flip" style="max-width: 636px">
			  <a class="btn btn-icon btn-light rounded-circle shadow position-absolute z-2" href="#!" style="top: 30%; left: 46%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="right" data-bs-custom-class="popover-sm" data-bs-content="
				<div class=&quot;d-flex align-items-start position-relative&quot;>
				  <img src=_assets/img/home/fashion/v2/hero/hotspot01.html width=&quot;64&quot; alt=&quot;Image&quot;>
				  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
					<a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_shop-product-fashion.html>Women beige trench coat</a>
					<div class=&quot;h6 mb-0&quot;>120.00</div>
				  </div>
				</div>
			  " tabindex="1" aria-label="Hotspot">
				<i class="ci-plus fs-base"></i>
			  </a>
			  <a class="btn btn-icon btn-light rounded-circle shadow position-absolute z-2" href="#!" style="top: 51%; left: 26%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="left" data-bs-custom-class="popover-sm" data-bs-content="
				<div class=&quot;d-flex align-items-start position-relative&quot;>
				  <img src=_assets/img/home/fashion/v2/hero/hotspot02.html width=&quot;64&quot; alt=&quot;Image&quot;>
				  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
					<a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_shop-product-fashion.html>White cotton blouset</a>
					<div class=&quot;h6 mb-0&quot;>38.50</div>
				  </div>
				</div>
			  " tabindex="1" aria-label="Hotspot">
				<i class="ci-plus fs-base"></i>
			  </a>
			  <a class="btn btn-icon btn-light rounded-circle shadow position-absolute z-2" href="#!" style="top: 81%; left: 40%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus" data-bs-placement="left" data-bs-custom-class="popover-sm" data-bs-content="
				<div class=&quot;d-flex align-items-start position-relative&quot;>
				  <img src=_assets/img/home/fashion/v2/hero/hotspot03.html width=&quot;64&quot; alt=&quot;Image&quot;>
				  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
					<a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_shop-product-fashion.html>Brown corduroy pants</a>
					<div class=&quot;h6 mb-0&quot;>64.99</div>
				  </div>
				</div>
			  " tabindex="1" aria-label="Hotspot">
				<i class="ci-plus fs-base"></i>
			  ...
			  <div class="ratio" style="--cz-aspect-ratio: calc(648 / 636 * 100%)">
				<img src="{{asset('front/img/home/fashion/v2/hero/image.png')}}" alt="Image">
			  </div>
			</div>
		  </div>
		</div>
	  ...
	  <div class="swiper-wrapper">
		  ...
		  <div class="hover-effect-opacity position-relative">
			<div class="d-flex justify-content-between position-relative z-2 ps-2 ps-xl-3">
			  <div class="d-flex flex-column min-w-0 p-3">
				...
				<ul class="nav flex-column gap-2 mt-n1">
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Sports suits</a>
				  </li>
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Trousers</a>
				  </li>
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Jackets and coats</a>
				  </li>
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Shirts</a>
				  </li>
				</ul>
				<div class="nav hover-effect-target opacity-0 pb-2 pb-xl-3 mt-auto">
				  <a class="nav-link animate-underline text-body-emphasis text-nowrap p-0" href="shop-catalog-fashion.html">
			  ...
			  <div class="ratio w-100 align-self-end" style="max-width: 220px; --cz-aspect-ratio: calc(305 / 220 * 100%)">
				<img src="{{asset('front/img/shop/grocery/categories/01.png')}}" alt="Image">
			  </div>
			</div>
		...
		<div class="swiper-slide">
		  <div class="hover-effect-opacity position-relative">
			<div class="d-flex justify-content-between position-relative z-2 ps-2 ps-xl-3">
			  <div class="d-flex flex-column min-w-0 p-3">
				<h2 class="h5 text-nowrap pt-2 pt-xl-3">For women</h2>
				<ul class="nav flex-column gap-2 mt-n1">
				  <li class="d-flex w-100 pt-1">
				  ...
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Pants and jeans</a>
				  </li>
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Shirts and blouses</a>
				  </li>
				  <li class="d-flex w-100 pt-1">
			  ...
			  <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 220px; --cz-aspect-ratio: calc(305 / 220 * 100%)">
				<img src="{{asset('front/img/shop/grocery/categories/02.png')}}" alt="Image">
			  </div>
			</div>
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none-dark" style="background: linear-gradient(119deg, #e9e0eb 0%, #f8eff1 52.24%)"></span>
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none d-block-dark" style="background: linear-gradient(119deg, #2f2c3a 0%, #372e2f 52.24%)"></span>
		  </div>
		</div>
		...
		<div class="swiper-slide">
		  <div class="hover-effect-opacity position-relative">
			<div class="d-flex justify-content-between position-relative z-2 ps-2 ps-xl-3">
			  <div class="d-flex flex-column min-w-0 p-3">
				<h2 class="h5 text-nowrap pt-2 pt-xl-3">Accessories</h2>
				<ul class="nav flex-column gap-2 mt-n1">
				  <li class="d-flex w-100 pt-1">
					<a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-fashion.html">Caps and hats</a>
				  </li>
				  <li class="d-flex w-100 pt-1">
			  ...
			  <div class="ratio w-100 align-self-end rtl-flip" style="max-width: 220px; --cz-aspect-ratio: calc(305 / 220 * 100%)">
				<img src="{{asset('front/img/home/fashion/v2/categories/03.png')}}" alt="Image">
			  </div>
			</div>
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none-dark" style="background: linear-gradient(118deg, #e9e8e8 0%, #e2ecea 51.13%)"></span>
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none d-block-dark" style="background: linear-gradient(118deg, #323232 0%, #252928 51.13%)"></span>
		  </div>
		</div>
	  </div>
  ...
  <section class="container pt-5 mt-2 mt-sm-3 mt-lg-4 mt-xl-5">
	...
	<div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 gy-4 gy-md-5">
		  ...
		  <div class="position-relative mb-3">
			...
			<a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
			  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
				<img src="{{asset('front/img/shop/fashion/01.png')}}" alt="Image">
			  </div>
			</a>
	  ...
	  <div class="col mb-2 mb-sm-3 mb-md-0">
		<div class="animate-underline hover-effect-opacity">
		  <div class="position-relative mb-3">
			...
			<a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
			  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
				<img src="{{asset('front/img/shop/fashion/05.png')}}" alt="Image">
			  </div>
			</a>
		  </div>
		  <div class="nav mb-2">
	  ...
	  <div class="col mb-2 mb-sm-3 mb-md-0">
		<div class="animate-underline hover-effect-opacity">
		  <div class="position-relative mb-3">
			...
			<a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
			  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
				<img src="{{asset('front/img/shop/fashion/02.png')}}" alt="Image">
			  </div>
			</a>
			<div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
			  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
	  ...
	  <div class="col mb-2 mb-sm-3 mb-md-0">
		<div class="animate-underline hover-effect-opacity">
		  <div class="position-relative mb-3">
			...
			<a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
			  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
				<img src="{{asset('front/img/shop/fashion/04.png')}}" alt="Image">
			  </div>
			</a>
		  </div>
		  <div class="nav mb-2">
	  ...
	  <!-- Banner -->
	  <div class="col-12 col-md-8 col-lg-6 mb-2 mb-sm-3 mb-md-0">
			...
			<div class="swiper-wrapper">
			  <div class="swiper-slide">
				<div class="ratio" style="--cz-aspect-ratio: calc(230 / 342 * 100%)">
				  <img src="{{asset('front/img/shop/fashion/banner01.png')}}" alt="Image">
				</div>
			  </div>
			  <div class="swiper-slide">
				<div class="ratio" style="--cz-aspect-ratio: calc(230 / 342 * 100%)">
				  <img src="{{asset('front/img/shop/fashion/banner02.png')}}" alt="Image">
				</div>
			  </div>
			  <div class="swiper-slide">
				<div class="ratio" style="--cz-aspect-ratio: calc(230 / 342 * 100%)">
				  <img src="{{asset('front/img/shop/fashion/banner03.png')}}" alt="Image">
				</div>
			  </div>
			</div>
		  </div>
	  ...
	  <div class="col mb-2 mb-sm-3 mb-md-0">
		<div class="animate-underline hover-effect-opacity">
		  <div class="position-relative mb-3">
			...
			<a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
			  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
				<img src="{{asset('front/img/shop/fashion/03.png')}}" alt="Image">
			  </div>
			</a>
			<div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
			  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
	  ...
	  <div class="col mb-2 mb-sm-3 mb-md-0">
		<div class="animate-underline hover-effect-opacity">
		  <div class="position-relative mb-3">
			...
			<a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html">
			  <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
				<img src="{{asset('front/img/shop/fashion/06.png')}}" alt="Image">
			  </div>
			</a>
			<div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
			  <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
  ...
  <section class="container pt-5 mt-2 mt-sm-3 mt-lg-4 mt-xl-5">
	...
	<div class="position-relative px-4 px-md-3 px-lg-4">
			...
			<div class="swiper-wrapper">
			  ...
			  <div class="swiper-slide h-auto">
				<div class="card animate-underline h-100 rounded-5 border-0">
				  <div class="pt-3 px-3">
					<span class="badge text-bg-danger position-absolute top-0 start-0 z-2 mt-2 mt-sm-3 ms-2 ms-sm-3">-30%</span>
					<img src="{{asset('front/img/home/fashion/v2/offers-slider/product01.png')}}" alt="Image">
				  </div>
				  <div class="card-body text-center py-3">
					<div class="d-flex justify-content-center min-w-0 fs-sm fw-medium text-dark-emphasis mb-2">
					  <span class="animate-target text-truncate">Polarized sunglasses for men</span>
					</div>
					<div class="h6 mb-3">$56.00 <del class="fs-sm fw-normal text-body-tertiary">$80.00</del></div>
					<a class="btn btn-sm btn-dark stretched-link" href="shop-product-fashion.html">Shop now</a>
				  </div>

				  <!-- Replace "demoDate" inside data-countdown-date attribute with the real date, ex: "10/15/2025 12:00:00" -->
				  <div class="card-footer d-flex align-items-center justify-content-center bg-transparent border-0 pb-4" data-countdown-date="demoDate">
			  ...
			  <div class="swiper-slide h-auto">
				<div class="card animate-underline h-100 rounded-5 border-0">
				  <div class="pt-3 px-3">
					...
					<img src="{{asset('front/img/home/fashion/v2/offers-slider/product02.png')}}" alt="Image">
				  </div>
				  <div class="card-body text-center py-3">
					<div class="d-flex justify-content-center min-w-0 fs-sm fw-medium text-dark-emphasis mb-2">
					  <span class="animate-target text-truncate">Fashionalble women fedora hat</span>
					</div>
					<div class="h6 mb-3">$43.00 <del class="fs-sm fw-normal text-body-tertiary">$50.00</del></div>
					<a class="btn btn-sm btn-dark stretched-link" href="shop-product-fashion.html">Shop now</a>
				  </div>
			...
			<div class="swiper-wrapper">
			  <div class="swiper-slide">
				<div class="ratio" style="--cz-aspect-ratio: calc(542 / 718 * 100%)">
				  <img src="{{asset('front/img/home/fashion/v2/offers-slider/preview01.png')}}" alt="Image">
				</div>
			  </div>
			  <div class="swiper-slide">
				<div class="ratio" style="--cz-aspect-ratio: calc(542 / 718 * 100%)">
				  <img src="{{asset('front/img/home/fashion/v2/offers-slider/preview02.png')}}" alt="Image">
				</div>
			  </div>
			</div>
		  </div>
	  ...
	  <div class="swiper position-absolute top-0 start-0 w-100 h-100 user-select-none" id="backgrounds" data-swiper="{
		...
		<div class="swiper-wrapper">
		  <div class="swiper-slide">
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none-dark" style="background-color: #dceee7"></span>
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none d-block-dark" style="background-color: #1b282c"></span>
		  </div>
		  <div class="swiper-slide">
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none-dark" style="background-color: #dddad7"></span>
			<span class="position-absolute top-0 start-0 w-100 h-100 rounded-5 d-none d-block-dark" style="background-color: #272729"></span>
		  </div>
		</div>
	  </div>
	</div>
	  ...
	  <div class="col-sm-10 col-md-12">
		<div class="row g-0 border rounded-5 overflow-hidden">
		  <div class="col-8 col-md-4 d-flex flex-column border-end">
			<a class="hover-effect-opacity position-relative d-block text-body border-bottom" href="#!">
			  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/zara-light.svg')}}" alt="Zara">
			  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/zara-dark.svg')}}" alt="Zara">
			...
			<a class="hover-effect-opacity position-relative d-block h-100 text-body" href="#!">
			  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/brooks-light.svg')}}" alt="Brooks">
			  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/brooks-dark.svg')}}" alt="Brooks">
			  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
			</a>
		  </div>
		  <div class="col-4 col-md-2 d-flex">
			<div class="d-flex flex-column w-100">
			  <a class="hover-effect-opacity position-relative d-block border-bottom text-body" href="#!">
				<img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/fila-light.svg')}}" alt="Fila">
				<img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/fila-dark.svg')}}" alt="Fila">
				<span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
			  </a>
			  <a class="hover-effect-opacity position-relative d-block h-100 text-body" href="#!">
				<img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/adidas-light.svg')}}" alt="Adidas">
				<img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/adidas-dark.svg')}}" alt="Adidas">
				<span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
			  </a>
			</div>
			...
			<div class="row row-cols-2 g-0 border-bottom border-end">
			  <div class="col">
				<a class="hover-effect-opacity position-relative d-block text-body" href="#!">
				  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/hermes-light.svg')}}" alt="Hermes">
				  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/hermes-dark.svg')}}" alt="Hermes">
				  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
				</a>
			  </div>
			  <div class="col border-start">
				<a class="hover-effect-opacity position-relative d-block h-100 text-body" href="#!">
				  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/dior-light.svg')}}" alt="Dior">
				  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/dior-dark.svg')}}" alt="Dior">
				  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
				</a>
			  </div>
			</div>
			<a class="hover-effect-opacity position-relative d-block h-100 border-end text-body" href="#!">
			  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/newbalance-light.svg')}}" alt="New Balance">
			  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/newbalance-dark.svg')}}" alt="New Balance">
			  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
			</a>
		  </div>
		  <div class="col-4 col-md-2">
			<a class="hover-effect-opacity position-relative d-block text-body border-bottom" href="#!">
			  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/puma-light.svg')}}" alt="Puma">
			  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/puma-dark.svg')}}" alt="Puma">
			  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
			</a>
			<a class="hover-effect-opacity position-relative d-block text-body" href="#!">
			  <img class="position-relative z-1 d-none-dark" src="{{asset('front/img/home/fashion/v2/brands/hm-light.svg')}}" alt="H &amp; M">
			  <img class="position-relative z-1 d-none d-block-dark" src="{{asset('front/img/home/fashion/v2/brands/hm-dark.svg')}}" alt="H &amp; M">
			  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-tertiary opacity-0"></span>
			</a>
		  </div>
		</div>
	  ...
	  <div class="d-flex gap-2 gap-md-3 gap-lg-4" style="min-width: 700px">
		<a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
		  ...
		  <div class="hover-effect-target ratio ratio-1x1">
			<img src="{{asset('front/img/instagram/01.jpg')}}" alt="Instagram image">
		  </div>
		</a>
		<a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
		  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
		  <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
		  <div class="hover-effect-target ratio ratio-1x1">
			<img src="{{asset('front/img/instagram/02.jpg')}}" alt="Instagram image">
		  </div>
		</a>
		<a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
		  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
		  <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
		  <div class="hover-effect-target ratio ratio-1x1">
			<img src="{{asset('front/img/instagram/03.jpg')}}" alt="Instagram image">
		  </div>
		</a>
		<a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
		  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
		  <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
		  <div class="hover-effect-target ratio ratio-1x1">
			<img src="{{asset('front/img/instagram/04.jpg')}}" alt="Instagram image">
		  </div>
		</a>
		<a class="hover-effect-scale hover-effect-opacity position-relative w-100 overflow-hidden" href="#!">
		  <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-25 opacity-0 z-1"></span>
		  <i class="ci-instagram hover-effect-target fs-4 text-white position-absolute top-50 start-50 translate-middle opacity-0 z-2"></i>
		  <div class="hover-effect-target ratio ratio-1x1">
			<img src="{{asset('front/img/instagram/05.jpg')}}" alt="Instagram image">
		  </div>
		</a>
	  </div>
	</div>
